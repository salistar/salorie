...
import {
  ...
  Link2, Replace, Award, UtensilsCrossed, Apple, Timer,
...
const TXT: any = {
  en: { title: 'Kitchen & meals', sub: 'All your food tools in one place.',
    ...
    aiplan: 'AI meal plan', shopping: 'Shopping list', fridge: 'Fridge → recipes', importr: 'Import recipe', subs: 'Substitutions',
  ...
  fr: { title: 'Cuisine & repas', sub: 'Tous tes outils alimentaires au même endroit.',
    ...
    aiplan: 'Plan repas IA', shopping: 'Liste de courses', fridge: 'Frigo → recettes', importr: 'Importer recette', subs: 'Substitutions',
  ...
  ar: { title: 'المطبخ والوجبات', sub: 'كل أدوات التغذية في مكان واحد.',
    ...
    aiplan: 'خطة وجبات AI', shopping: 'قائمة التسوق', fridge: 'الثلاجة ← وصفات', importr: 'استيراد وصفة', subs: 'بدائل',
          ...
          <View key={sec.key} style={styles.section}>
            ...
            <View style={styles.grid}>
              {sec.items.map((it) => (
                ...
                >
                  <View style={[styles.iconWrap, { backgroundColor: isDark ? 'rgba(46,139,87,0.16)' : '#EAF4EE' }]}>
                    <it.Icon size={26} color={GREEN} />
                  </View>
                  <Text style={[styles.tileLabel, { color: text }]} numberOfLines={2}>{it.label}</Text>
                </TouchableOpacity>
              ))}
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  tile: { width: '47%', borderRadius: 20, borderWidth: 1, paddingVertical: 22, paddingHorizontal: 12, alignItems: 'center', gap: 12, marginBottom: 12 },
