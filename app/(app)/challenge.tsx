...
function buildHtml(route: LatLng[], me: LatLng, color: string, fond: string, erreur: string): string {
  const start = route[0];
...
export default function ChallengeScreen() {
  ...
  const html = useMemo(
    () => (challenge ? buildHtml(challenge.route as LatLng[], mePoint, k.accent, k.bg, k.danger) : ''),
