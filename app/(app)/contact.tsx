...
const makeS = (k: Tokens) => StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: '800', color: k.text },
  ...
  input: { backgroundColor: k.surface, borderRadius: 12, borderWidth: 1, borderColor: k.border, padding: 14, fontSize: 15, color: k.text },
  ...
  doneTxt: { fontSize: 20, fontWeight: '800', color: k.text, marginTop: 16 },
