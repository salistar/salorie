...
const RUN_ACTIVITIES = [
  {
    ...
    image: require('../../assets/images/exercices/running.png'),
    mets: [7, 9.8, 12.5], // low/med/high
  },
  {
    id: 'walking',
    labelKey: 'act.walking',
    image: require('../../assets/images/exercices/walking.png'),
    mets: [2.5, 3.5, 5.0],
  },
  {
    id: 'cycling',
    labelKey: 'act.cycling',
    image: require('../../assets/images/exercices/cycling.png'),
    mets: [4, 8, 12],
  },
  {
    id: 'swimming',
    labelKey: 'act.swimming',
    image: require('../../assets/images/exercices/swimming.png'),
    mets: [5.8, 8.3, 10],
  },
  {
    id: 'hiking',
    labelKey: 'act.hiking',
    image: require('../../assets/images/exercices/hiking.png'),
    mets: [5, 6, 7.3],
  },
  {
    id: 'rowing',
    labelKey: 'act.rowing',
    image: require('../../assets/images/exercices/rowing.png'),
    mets: [4.8, 7, 8.5],
  },
];
...
const LIFT_EXERCISES = [
  ...
  { id: 'bench_press', labelKey: 'lift.bench_press', image: require('../../assets/images/exercices/bench_press.png'), mets: [3, 5, 6], muscles: ['muscle.chest', 'muscle.triceps', 'muscle.shoulders'] },
  { id: 'squat', labelKey: 'lift.squat', image: require('../../assets/images/exercices/squat.png'), mets: [3.5, 5.5, 8], muscles: ['muscle.quads', 'muscle.glutes', 'muscle.hamstrings', 'muscle.core'] },
  { id: 'deadlift', labelKey: 'lift.deadlift', image: require('../../assets/images/exercices/deadlift.png'), mets: [3.5, 6, 8], muscles: ['muscle.back', 'muscle.hamstrings', 'muscle.glutes', 'muscle.forearms'] },
  { id: 'shoulder_press', labelKey: 'lift.shoulder_press', image: require('../../assets/images/exercices/shoulder_press.png'), mets: [3, 4.5, 6], muscles: ['muscle.shoulders', 'muscle.triceps', 'muscle.core'] },
  { id: 'pullup', labelKey: 'lift.pullup', image: require('../../assets/images/exercices/pullup.png'), mets: [3, 5, 8], muscles: ['muscle.back', 'muscle.biceps', 'muscle.forearms'] },
  { id: 'bicep_curl', labelKey: 'lift.bicep_curl', image: require('../../assets/images/exercices/bicep_curl.png'), mets: [2.5, 3.5, 5], muscles: ['muscle.biceps', 'muscle.forearms'] },
  { id: 'incline_bench', labelKey: 'lift.incline_bench', image: require('../../assets/images/exercices/incline_bench.png'), mets: [3, 5, 6], muscles: ['muscle.chest', 'muscle.shoulders', 'muscle.triceps'] },
  { id: 'dumbbell_row', labelKey: 'lift.dumbbell_row', image: require('../../assets/images/exercices/dumbbell_row.png'), mets: [3, 5, 6.5], muscles: ['muscle.back', 'muscle.biceps'] },
  { id: 'barbell_row', labelKey: 'lift.barbell_row', image: require('../../assets/images/exercices/barbell_row.png'), mets: [3.5, 5.5, 7], muscles: ['muscle.back', 'muscle.biceps', 'muscle.rear_delts'] },
  { id: 'lat_pulldown', labelKey: 'lift.lat_pulldown', image: require('../../assets/images/exercices/lat_pulldown.png'), mets: [3, 4.5, 6], muscles: ['muscle.back', 'muscle.biceps'] },
  { id: 'leg_press', labelKey: 'lift.leg_press', image: require('../../assets/images/exercices/leg_press.png'), mets: [3.5, 5.5, 7.5], muscles: ['muscle.quads', 'muscle.glutes', 'muscle.hamstrings'] },
  { id: 'lunges', labelKey: 'lift.lunges', image: require('../../assets/images/exercices/lunges.png'), mets: [3, 5, 7], muscles: ['muscle.quads', 'muscle.glutes', 'muscle.hamstrings'] },
  { id: 'romanian_dl', labelKey: 'lift.romanian_dl', image: require('../../assets/images/exercices/romanian_dl.png'), mets: [3.5, 6, 8], muscles: ['muscle.hamstrings', 'muscle.glutes', 'muscle.back'] },
  { id: 'tricep_dips', labelKey: 'lift.tricep_dips', image: require('../../assets/images/exercices/tricep_dips.png'), mets: [3, 5, 8], muscles: ['muscle.triceps', 'muscle.chest', 'muscle.shoulders'] },
  { id: 'tricep_pushdown', labelKey: 'lift.tricep_pushdown', image: require('../../assets/images/exercices/tricep_pushdown.png'), mets: [2.5, 3.5, 5], muscles: ['muscle.triceps'] },
  { id: 'hammer_curl', labelKey: 'lift.hammer_curl', image: require('../../assets/images/exercices/hammer_curl.png'), mets: [2.5, 3.5, 5], muscles: ['muscle.biceps', 'muscle.forearms'] },
  { id: 'preacher_curl', labelKey: 'lift.preacher_curl', image: require('../../assets/images/exercices/preacher_curl.png'), mets: [2.5, 3.5, 5], muscles: ['muscle.biceps'] },
  { id: 'lateral_raise', labelKey: 'lift.lateral_raise', image: require('../../assets/images/exercices/lateral_raise.png'), mets: [2.5, 3.5, 5], muscles: ['muscle.shoulders'] },
  { id: 'front_raise', labelKey: 'lift.front_raise', image: require('../../assets/images/exercices/front_raise.png'), mets: [2.5, 3.5, 5], muscles: ['muscle.shoulders'] },
  { id: 'face_pull', labelKey: 'lift.face_pull', image: require('../../assets/images/exercices/face_pull.png'), mets: [2.5, 3.5, 5], muscles: ['muscle.rear_delts', 'muscle.back'] },
  { id: 'chest_fly', labelKey: 'lift.chest_fly', image: require('../../assets/images/exercices/chest_fly.png'), mets: [2.5, 3.5, 5], muscles: ['muscle.chest'] },
  { id: 'cable_crossover', labelKey: 'lift.cable_crossover', image: require('../../assets/images/exercices/cable_crossover.png'), mets: [2.5, 3.5, 5], muscles: ['muscle.chest'] },
  { id: 'calf_raise', labelKey: 'lift.calf_raise', image: require('../../assets/images/exercices/calf_raise.png'), mets: [2.5, 3.5, 5], muscles: ['muscle.calves'] },
  { id: 'leg_curl', labelKey: 'lift.leg_curl', image: require('../../assets/images/exercices/leg_curl.png'), mets: [3, 4.5, 6], muscles: ['muscle.hamstrings'] },
  { id: 'leg_extension', labelKey: 'lift.leg_extension', image: require('../../assets/images/exercices/leg_extension.png'), mets: [3, 4.5, 6], muscles: ['muscle.quads'] },
  { id: 'hip_thrust', labelKey: 'lift.hip_thrust', image: require('../../assets/images/exercices/hip_thrust.png'), mets: [3, 5, 7], muscles: ['muscle.glutes', 'muscle.hamstrings'] },
  { id: 'bulgarian_split', labelKey: 'lift.bulgarian_split', image: require('../../assets/images/exercices/bulgarian_split.png'), mets: [3.5, 5.5, 8], muscles: ['muscle.quads', 'muscle.glutes', 'muscle.core'] },
  { id: 'plank', labelKey: 'lift.plank', kind: 'time', image: require('../../assets/images/exercices/plank.png'), mets: [2.8, 4, 5], muscles: ['muscle.core', 'muscle.shoulders', 'muscle.full_body'] },
  { id: 'crunches', labelKey: 'lift.crunches', image: require('../../assets/images/exercices/crunches.png'), mets: [2.8, 4, 5.5], muscles: ['muscle.core'] },
  { id: 'russian_twist', labelKey: 'lift.russian_twist', image: require('../../assets/images/exercices/russian_twist.png'), mets: [2.8, 4, 5.5], muscles: ['muscle.core', 'muscle.obliques'] },
  { id: 'hanging_knee', labelKey: 'lift.hanging_knee', image: require('../../assets/images/exercices/hanging_knee.png'), mets: [3, 4.5, 6], muscles: ['muscle.core', 'muscle.forearms'] },
